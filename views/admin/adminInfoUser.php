...
<div id="body">
    ...
    <h1>Information du <?php if ($_GET['typeOfUser'] == 'doctor') {
            echo 'docteur';
        } else {
            echo 'pilote';
        } ?></h1>
    ...
    ?>
    <a href="editUsers?userId=<?php echo $_GET["userId"]; ?>&typeOfUser=<?php echo $_GET['typeOfUser']; ?> "><img
                src="/design/img/edit.png" alt="edit"></a>
    ...
    <table>
        ...
        if ($patient) {
            ...
            while ($patient) {
                ...
                <tr>
                    <td>
                        <a href="infoPilote?piloteId=<?php echo $patient["piloteId"]; ?>"><?php echo $patient["name"]; ?></a>
                    </td>
